...
public class SwirlDemo extends Showcase.Demo {
  ...
  @Override public void create (Showcase game, Closeable.Set onClose) {
    ...
    Image Marine = game.plat.assets().getImage("swirl/girlcat.png");
    final ImageLayer layer0 = new ImageLayer(Marine);
    final ImageLayer layer1 = new ImageLayer(Marine);
    final ImageLayer layer2 = new ImageLayer(Marine);
    final ImageLayer layer3 = new ImageLayer(Marine);
